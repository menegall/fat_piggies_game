...
This project uses the following third-party assets, which are governed by their respective licenses.
...
* **Modifications:** Converted to Bitmap Font, color adjustments, and added borders by the Fat
  Piggies Team.
* **License:** SIL Open Font License, Version 1.1

```text
Copyright 2023 The Soft Type Project Authors 
([https://github.com/scfried/soft-type-jersey](https://github.com/scfried/soft-type-jersey))
...
font projects, to support the font creation efforts of academic and linguistic communities, 
and to provide a free and open framework in which fonts may be shared and improved in partnership 
with others.
